# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2018-02-16 05:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('server', models.CharField(default='KGS', max_length=10)),
                ('event_type', models.CharField(choices=[('ladder', 'ladder'), ('league', 'league'), ('tournament', 'tournament'), ('meijin', 'meijin'), ('ddk', 'ddk')], default='ladder', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('division', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='league.Division')),
